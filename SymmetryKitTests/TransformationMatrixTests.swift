//
//  TransformationMatrixTests.swift
//  SymmetryKitTests
//
//  Created by David Dubbeldam on 14/07/2021.
...
class TransformationMatrixTests: XCTestCase
{
    ...
    for fileName in testData
    {
      if let url: URL = bundle.url(forResource: fileName, withExtension: nil)
      {
        ...
        if let unitCell = reader.unitCell
        {
          ...
          {
            let originalUnitCell: double3x3 = spacegroup.rotationMatrix * spacegroup.cell.unitCell * spacegroup.transformationMatrix
            XCTAssertEqual(originalUnitCell[0][0], unitCell[0][0], accuracy: precision, "Wrong a found for \(fileName) have \(originalUnitCell) should be \(unitCell)")
            XCTAssertEqual(originalUnitCell[0][1], unitCell[0][1], accuracy: precision, "Wrong a found for \(fileName) have \(originalUnitCell) should be \(unitCell)")
            XCTAssertEqual(originalUnitCell[0][2], unitCell[0][2], accuracy: precision, "Wrong a found for \(fileName) have \(originalUnitCell) should be \(unitCell)")
            XCTAssertEqual(originalUnitCell[1][0], unitCell[1][0], accuracy: precision, "Wrong a found for \(fileName) have \(originalUnitCell) should be \(unitCell)")
            XCTAssertEqual(originalUnitCell[1][1], unitCell[1][1], accuracy: precision, "Wrong a found for \(fileName) have \(originalUnitCell) should be \(unitCell)")
            XCTAssertEqual(originalUnitCell[1][2], unitCell[1][2], accuracy: precision, "Wrong a found for \(fileName) have \(originalUnitCell) should be \(unitCell)")
            XCTAssertEqual(originalUnitCell[2][0], unitCell[2][0], accuracy: precision, "Wrong a found for \(fileName) have \(originalUnitCell) should be \(unitCell)")
            XCTAssertEqual(originalUnitCell[2][1], unitCell[2][1], accuracy: precision, "Wrong a found for \(fileName) have \(originalUnitCell) should be \(unitCell)")
            XCTAssertEqual(originalUnitCell[2][2], unitCell[2][2], accuracy: precision, "Wrong a found for \(fileName) have \(originalUnitCell) should be \(unitCell)")
  ...
  // Test-cases assembled in Spglib by Atsushi Togo (https://github.com/spglib/spglib)
  func testOrthorhombicSpaceGroupTransformationMatrix()
  {
    let testData: [String] =
      [
  ...
  // Test-cases assembled in Spglib by Atsushi Togo (https://github.com/spglib/spglib)
  func testTetragonalSpaceGroupTransformationMatrix()
  {
    let testData: [String] =
      [
  ...
  // Test-cases assembled in Spglib by Atsushi Togo (https://github.com/spglib/spglib)
  func testTrigonalSpaceGroupTransformationMatrix()
  {
    let testData: [String] =
      [
  ...
  // Test-cases assembled in Spglib by Atsushi Togo (https://github.com/spglib/spglib)
  func testHexogonalSpaceGroupTransformationMatrix()
  {
    let testData: [String] =
      [
  ...
  // Test-cases assembled in Spglib by Atsushi Togo (https://github.com/spglib/spglib)
  func testCubicSpaceGroupTransformationMatrix()
  {
    let testData: [String] =
      [
  ...
  // Test-cases assembled in Spglib by Atsushi Togo (https://github.com/spglib/spglib)
  func testVirtualSpaceGroupTransformationMatrix()
  {
    let testData: [String] =
      [
  ...
  // Test-cases assembled in Spglib by Atsushi Togo (https://github.com/spglib/spglib)
  func testFindSpaceGroupTransformationDebug()
  {
    let testData: [String: double3x3] =
      [
       
        "SpglibTestData/orthorhombic/POSCAR-065-3": double3x3(SIMD3<Double>( -1.0 , 0.0 , 0.0 ), SIMD3<Double>( 0.0 , 0.0 , 1.0 ), SIMD3<Double>( 0.0 , 1.0 , -1.57144168016e-16 ))
      ...
      if let url: URL = bundle.url(forResource: fileName, withExtension: nil)
      {
        ...
        if let unitCell = reader.unitCell
        {
          ...
          if let spacegroup = spacegroup
          {
            ...
            XCTAssertEqual(originalUnitCell[0][0], unitCell[0][0], accuracy: precision, "Wrong a found for \(fileName) have \(spacegroup.transformationMatrix) should be \(reference)")
            XCTAssertEqual(originalUnitCell[0][1], unitCell[0][1], accuracy: precision, "Wrong a found for \(fileName) have \(spacegroup.transformationMatrix) should be \(reference)")
            XCTAssertEqual(originalUnitCell[0][2], unitCell[0][2], accuracy: precision, "Wrong a found for \(fileName) have \(spacegroup.transformationMatrix) should be \(reference)")
            XCTAssertEqual(originalUnitCell[1][0], unitCell[1][0], accuracy: precision, "Wrong a found for \(fileName) have \(spacegroup.transformationMatrix) should be \(reference)")
            XCTAssertEqual(originalUnitCell[1][1], unitCell[1][1], accuracy: precision, "Wrong a found for \(fileName) have \(spacegroup.transformationMatrix) should be \(reference)")
            XCTAssertEqual(originalUnitCell[1][2], unitCell[1][2], accuracy: precision, "Wrong a found for \(fileName) have \(spacegroup.transformationMatrix) should be \(reference)")
            XCTAssertEqual(originalUnitCell[2][0], unitCell[2][0], accuracy: precision, "Wrong a found for \(fileName) have \(spacegroup.transformationMatrix) should be \(reference)")
            XCTAssertEqual(originalUnitCell[2][1], unitCell[2][1], accuracy: precision, "Wrong a found for \(fileName) have \(spacegroup.transformationMatrix) should be \(reference)")
            XCTAssertEqual(originalUnitCell[2][2], unitCell[2][2], accuracy: precision, "Wrong a found for \(fileName) have \(spacegroup.transformationMatrix) should be \(reference)")
