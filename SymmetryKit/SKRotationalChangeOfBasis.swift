...
public struct SKRotationalChangeOfBasis
{
  ...
  [
    ...
    SKRotationalChangeOfBasis(rotation: SKRotationMatrix([SIMD3<Int32>( 0, 0, 1), SIMD3<Int32>( 0,-1, 0), SIMD3<Int32>( 1, 0, 0)])), //  4 : R2          c, -b,    a    yes
    ...
    SKRotationalChangeOfBasis(rotation: SKRotationMatrix([SIMD3<Int32>( 0,  1, 0), SIMD3<Int32>( 0, 0, 1), SIMD3<Int32>( 1,  0,  0)])), // a c -b
    ...
    SKRotationalChangeOfBasis(rotation: SKRotationMatrix([SIMD3<Int32>( 0,  0,  1), SIMD3<Int32>( 1, 0, 0), SIMD3<Int32>( 0,  1,  0)])),  // c a b
    ...
    SKRotationalChangeOfBasis(rotation: SKRotationMatrix([SIMD3<Int32>( 1,  0,  0), SIMD3<Int32>( 0, 0, 1), SIMD3<Int32>( 0, -1,  0)])), // a c -b
