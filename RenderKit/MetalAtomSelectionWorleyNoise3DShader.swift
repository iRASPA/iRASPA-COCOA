//
//  MetalAtomSelectionWorleyNoise3DShader.swift
//  RenderKit
//
...
class MetalAtomSelectionWorleyNoise3DShader
{
  ...
  public func buildPipeLine(device: MTLDevice, library: MTLLibrary, vertexDescriptor: MTLVertexDescriptor,  maximumNumberOfSamples: Int)
  {
    ...
    pipelineDescriptor.vertexFunction = library.makeFunction(name: "AtomSelectionWorleyNoise3DSphereVertexShader")!
    ...
    pipelineDescriptor.fragmentFunction = library.makeFunction(name: "AtomSelectionWorleyNoise3DSphereFragmentShader")!
