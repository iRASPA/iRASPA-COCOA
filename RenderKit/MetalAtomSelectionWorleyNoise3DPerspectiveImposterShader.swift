//
//  MetalAtomSelectionWorleyNoise3DPerspectiveImposterShader.swift
//  RenderKit
//
...
class MetalAtomSelectionWorleyNoise3DPerspectiveImposterShader
{
  ...
  public func buildPipeLine(device: MTLDevice, library: MTLLibrary, vertexDescriptor: MTLVertexDescriptor,  maximumNumberOfSamples: Int)
  {
    ...
    pipelineDescriptor.vertexFunction = library.makeFunction(name: "AtomSelectionWorleyNoise3DPerspectiveVertexShader")!
    ...
    pipelineDescriptor.fragmentFunction = library.makeFunction(name: "AtomSelectionWorleyNoise3DPerspectiveFragmentShader")!
