//
//  MetalAtomPerspectiveImposterShader.swift
//  RenderKit
//
...
class MetalAtomPerspectiveImposterShader
{
  ...
  public func buildPipeLine(device: MTLDevice, library: MTLLibrary, vertexDescriptor: MTLVertexDescriptor,  maximumNumberOfSamples: Int)
  {
    ...
    pipelineDescriptor.vertexFunction = library.makeFunction(name: "AtomSphereImposterPerspectiveVertexShader")!
    pipelineDescriptor.sampleCount = maximumNumberOfSamples
    pipelineDescriptor.depthAttachmentPixelFormat = MTLPixelFormat.depth32Float_stencil8
    pipelineDescriptor.stencilAttachmentPixelFormat = MTLPixelFormat.depth32Float_stencil8
    pipelineDescriptor.fragmentFunction = library.makeFunction(name: "AtomSphereImposterPerspectiveFragmentShader")!
