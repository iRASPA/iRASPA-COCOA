//
//  MetalAtomSelectionStripesShader.swift
//  RenderKit
//
...
class MetalAtomSelectionStripesShader
{
  ...
  public func buildPipeLine(device: MTLDevice, library: MTLLibrary, vertexDescriptor: MTLVertexDescriptor,  maximumNumberOfSamples: Int)
  {
    ...
    pipelineDescriptor.vertexFunction = library.makeFunction(name: "AtomSelectionStripedSphereVertexShader")!
    ...
    pipelineDescriptor.fragmentFunction = library.makeFunction(name: "AtomSelectionStripedSphereFragmentShader")!
  ...
  public func renderWithEncoder(_ commandEncoder: MTLRenderCommandEncoder, renderPassDescriptor: MTLRenderPassDescriptor, instanceBuffer: [[MTLBuffer?]], atomShader: MetalAtomShader, frameUniformBuffer: MTLBuffer, structureUniformBuffers: MTLBuffer?, lightUniformBuffers: MTLBuffer?, size: CGSize)
  {
    if (self.renderStructures.joined().reduce(false, {$0 || $1.drawAtoms}))
    {
      ...
      commandEncoder.setVertexBuffer(atomShader.vertexBuffer, offset: 0, index: 0)
      ...
      for i in 0..<self.renderStructures.count
      {
        ...
        {
          if(structure.renderSelectionStyle == .striped)
          {
