// Auto-generated by Scripts/generate_lewiner_metal_tables.py — do not edit.
// Lewiner MC33 tables (Thomas Lewiner et al.). Regenerate with LookUpTable.h as input.
#ifndef MARCHING_CUBES_LEWINER_TABLES_H
#define MARCHING_CUBES_LEWINER_TABLES_H

// Edge endpoint corner indices (Lewiner convention).
constant int2 lewinerEdgeCorners[12] = {
  int2(0, 1), int2(1, 2), int2(2, 3), int2(3, 0),
  int2(4, 5), int2(5, 6), int2(6, 7), int2(7, 4),
  int2(0, 4), int2(1, 5), int2(2, 6), int2(3, 7)
};

constant uint3 lewinerCornerOffset[8] = {
  uint3(0, 0, 0), uint3(1, 0, 0), uint3(1, 1, 0), uint3(0, 1, 0),
  uint3(0, 0, 1), uint3(1, 0, 1), uint3(1, 1, 1), uint3(0, 1, 1)
};

constant signed char lewinerCases[256][2] = {
  { 0, -1 },
  { 1, 0 },
  { 1, 1 },
  { 2, 0 },
...
constant signed char lewinerTiling1[16][3] = {
  { 0, 8, 3 },
  { 0, 1, 9 },
  { 1, 2, 10 },
  { 3, 11, 2 },
...
constant signed char lewinerTiling2[24][6] = {
  { 1, 8, 3, 9, 8, 1 },
  { 0, 11, 2, 8, 11, 0 },
  { 4, 3, 0, 7, 3, 4 },
  { 9, 2, 10, 0, 2, 9 },
...
constant signed char lewinerTest3[24] = {
  5, 1, 4, 5, 1, 2, 2, 3, 4, 3, 6, 6, -6, -6, -3, -4, -3, -2, -2, -1, -5, -4, -1, -5
};

constant signed char lewinerTiling3_1[24][6] = {
  { 0, 8, 3, 1, 2, 10 },
  { 9, 5, 4, 0, 8, 3 },
  { 3, 0, 8, 11, 7, 6 },
  { 1, 9, 0, 2, 3, 11 },
...
constant signed char lewinerTiling3_2[24][12] = {
...
constant signed char lewinerTest4[8] = {
  7, 7, 7, 7, -7, -7, -7, -7
};

constant signed char lewinerTiling4_1[8][6] = {
  { 0, 8, 3, 5, 10, 6 },
  { 0, 1, 9, 11, 7, 6 },
  { 1, 2, 10, 8, 4, 7 },
  { 9, 5, 4, 2, 3, 11 },
...
constant signed char lewinerTiling4_2[8][18] = {
...
constant signed char lewinerTiling5[48][9] = {
  { 2, 8, 3, 2, 10, 8, 10, 9, 8 },
...
constant signed char lewinerTest6[48][3] = {
  { 2, 7, 10 },
  { 4, 7, 11 },
  { 5, 7, 1 },
  { 5, 7, 3 },
...
constant signed char lewinerTiling6_1_1[48][9] = {
  { 6, 5, 10, 3, 1, 8, 9, 8, 1 },
  { 11, 7, 6, 9, 3, 1, 3, 9, 8 },
  { 1, 2, 10, 7, 0, 4, 0, 7, 3 },
  { 3, 0, 8, 5, 2, 6, 2, 5, 1 },
...
constant signed char lewinerTiling6_1_2[48][27] = {
...
constant signed char lewinerTiling6_2[48][15] = {
...
constant signed char lewinerTest7[16][5] = {
  { 1, 2, 5, 7, 1 },
  { 3, 4, 5, 7, 3 },
  { 4, 1, 6, 7, 4 },
  { 4, 1, 5, 7, 0 },
...
constant signed char lewinerTiling7_1[16][9] = {
  { 9, 5, 4, 10, 1, 2, 8, 3, 0 },
  { 11, 7, 6, 8, 3, 0, 10, 1, 2 },
  { 3, 0, 8, 5, 4, 9, 7, 6, 11 },
  { 8, 4, 7, 9, 0, 1, 11, 2, 3 },
...
constant signed char lewinerTiling7_2[16][3][15] = {
  {
...
constant signed char lewinerTiling7_3[16][3][27] = {
  {
...
constant signed char lewinerTiling7_4_1[16][15] = {
...
constant signed char lewinerTiling7_4_2[16][27] = {
...
constant signed char lewinerTiling8[6][6] = {
  { 9, 8, 10, 10, 8, 11 },
  { 1, 5, 3, 3, 5, 7 },
  { 0, 4, 2, 4, 6, 2 },
  { 0, 2, 4, 4, 2, 6 },
...
constant signed char lewinerTiling9[8][12] = {
...
constant signed char lewinerTest10[6][3] = {
  { 2, 4, 7 },
  { 5, 6, 7 },
  { 1, 3, 7 },
  { 1, 3, 7 },
...
constant signed char lewinerTiling10_1_1[6][12] = {
...
constant signed char lewinerTiling10_1_1_[6][12] = {
...
constant signed char lewinerTiling10_1_2[6][24] = {
...
constant signed char lewinerTiling10_2[6][24] = {
...
constant signed char lewinerTiling10_2_[6][24] = {
...
constant signed char lewinerTiling11[12][12] = {
...
constant signed char lewinerTest12[24][4] = {
  { 4, 3, 7, 11 },
  { 3, 2, 7, 10 },
  { 2, 6, 7, 5 },
  { 6, 4, 7, 7 },
...
constant signed char lewinerTiling12_1_1[24][12] = {
...
constant signed char lewinerTiling12_1_1_[24][12] = {
...
constant signed char lewinerTiling12_1_2[24][24] = {
...
constant signed char lewinerTiling12_2[24][24] = {
...
constant signed char lewinerTiling12_2_[24][24] = {
...
constant signed char lewinerTest13[2][7] = {
  { 1, 2, 3, 4, 5, 6, 7 },
  { 2, 3, 4, 1, 5, 6, 7 },
};

constant signed char lewinerSubconfig13[64] = {
  0, 1, 2, 7, 3, -1, 11, -1, 4, 8, -1, -1, 14, -1, -1, -1, 5, 9, 12, 23, 15, -1, 21, 38, 17, 20, -1, 36, 26, 33, 30, 44, 6, 10, 13, 19, 16, -1, 25, 37, 18, 24, -1, 35, 22, 32, 29, 43, -1, -1, -1, 34, -1, -1, 28, 42, -1, 31, -1, 41, 27, 40, 39, 45
};

constant signed char lewinerTiling13_1[2][12] = {
  { 11, 7, 6, 1, 2, 10, 8, 3, 0, 9, 5, 4 },
  { 8, 4, 7, 2, 3, 11, 9, 0, 1, 10, 6, 5 },
};

constant signed char lewinerTiling13_1_[2][12] = {
  { 7, 4, 8, 11, 3, 2, 1, 0, 9, 5, 6, 10 },
  { 6, 7, 11, 10, 2, 1, 0, 3, 8, 4, 5, 9 },
};

constant signed char lewinerTiling13_2[2][6][18] = {
  {
...
constant signed char lewinerTiling13_2_[2][6][18] = {
  {
...
constant signed char lewinerTiling13_3[2][12][30] = {
  {
...
constant signed char lewinerTiling13_3_[2][12][30] = {
  {
...
constant signed char lewinerTiling13_4[2][4][36] = {
  {
...
constant signed char lewinerTiling13_5_1[2][4][18] = {
  {
...
constant signed char lewinerTiling13_5_2[2][4][30] = {
  {
...
constant signed char lewinerTiling14[12][12] = {
...
#endif // MARCHING_CUBES_LEWINER_TABLES_H
